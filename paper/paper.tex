...
inherit desirable qualities of the back-end storage system, including the ability to make trade-offs 
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] Since 2010, the growth in the number of co-designed object
...
We will now discuss the common subsystems used to manage
...
measurements and analysis is forthcoming for both Mantle and ZLog, as we try
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] Sequencer throughput by re-using various services.
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] The latency distribution shows that if the clients hold their capabilities longer, performance decreases. Changing the delay via policy can help the sequencer and clients strike a balance between throughput and latency.}
\label{fig:capcdf}
\end{figure}
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] Cluster-wide interface update latency, excluding the Paxos proposal cost for
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] A ZLog sequencer that uses the CephFS MDS enjoys the load balancing
...
\caption{[\href{https://github.com/double-blind-submitter/osdi16}{source}] The sequencer using Mantle in Figure~\ref{fig:mantle-seq-thruput}

...
Load Balancing  & migration \& monitoring primitives   & \\
Versioning      & consistency primitives               & \\ 
Shared Resource & serialization \& batching primitives
                & \\
Durability      & persistence primitives
                & \\
Logical Device  & transaction \& atomicity primitives 
                & Swift/ZeroVM in situ storage \& compute [1] \\ 
\end{tabular}

...
Applications that manage large amounts of metadata (e.g. users or database
...
\newcomment{Many large scale storage systems separate metadata and data IO so
...
systems employ separate metadata clusters.}

\newcomment{\\ \noindent {\it{\textbf{Existing Ceph Implementation: }}}} Ceph
also addresses the challenge of balancing metadata load with a separate

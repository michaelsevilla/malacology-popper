...
locking service implements capabilities that express what data and metadata
...
reason about compatibility issues. Traditionally, interfaces are written
...
information into the monitor map, the structure that describes the
...
However, we found that the capability system in Ceph is used to batch access

...
\textbf{\text{*}}             &
\textbf{Provides...}          &
\textbf{Example in Storage} & \\ \hline
Versioning      & \cmark & consensus \& consistency primitives  & PAXOS in Chubby [2] \\ 
Shared Resource & \cmark & serialization \& batching primitives & \\
Logical Device  & \cmark & transaction \& atomicity primitives  & Swift/ZeroVM in situ storage \& compute [1] \\ 
Durability      &        & persistence primitives               & \\
Load Balancing  &        & migration \& monitoring primitives   & IndexFS~\cite{ren:sc2014-indexfs} \& GIGA+~\cite{patil:fast2011-giga} \\
\end{tabular}
\caption{The Malacology interfaces are commonly used abstractions used
internally in storage stacks.}
\label{table:implementation}
\end{table*}
% http://www.zerovm.org/zerocloud.html
% https://www.usenix.org/legacy/events/nsdi11/tech/full_papers/Bolosky.pdf
...
robustness of the subsystems of the underlying stack. The \cmark s are
interfaces contributed in this paper; durability is already provided with a
client library and the MDS Logical Device is already

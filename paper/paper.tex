...
In this section we describe the extensions to existing Ceph services that
allow for reusability.

{Lua Integration.} Because of limited space we describe our extensions
generally, but we have explicitly added the ability to use Lua to specify
the customizations. Lua is great because..., and let's us save and version
interfaces.

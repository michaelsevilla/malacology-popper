...
Figure~\ref{fig:mantle-balancer-beahviors}; in this scenario, half of the
...
API~\ref{sevilla:sc15-mantle} to send half of the load on the current server (whoami) to the next ranked

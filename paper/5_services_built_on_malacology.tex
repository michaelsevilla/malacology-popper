...
is Mantle~\cite{sevilla:sc15-mantle}, a framework for dynamically specifying file system metadata load balancing
...
We have re-implemented Mantle on Malacology so that Mantle can enjoy the
